...
class CoordinatorPolicyChain:
    """Coordinator validation helper shared by Application/Domain (DDD-safe).

    Notes:
    - Domain code MUST NOT import Application services; place shared logic here.
    - Application layer can wrap this (re-export) to preserve compatibility.
    """
