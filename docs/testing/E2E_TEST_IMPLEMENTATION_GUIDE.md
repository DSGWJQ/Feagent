...
> **最后验证**：2026-01-07（deterministic: 29/29；repeat-each=10: 290/290）
> **对应提交**：`7a4c7d2` / `924c829` / `b92ea97` / `ea0d8ff`
> **变更摘要**：固化 deterministic/hybrid/fullreal projects、PR/nightly CI 入口、失败闭环模板与稳定性门禁
